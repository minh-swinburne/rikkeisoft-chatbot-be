...
async def generate_answer(chat_history: list) :
    ...
    chat_completion:Union[ChatCompletion, Stream[ChatCompletionChunk]] = client.chat.completions.create(
        messages=[
...
async def generate_name(chat_history: list):
    ...
    name_completion:Union[ChatCompletion, Stream[ChatCompletionChunk]] = client.chat.completions.create(
        messages=[
            {
                "role": "system",
                "content": system_prompt,
