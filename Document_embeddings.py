...
def save_embeddings(embeddings, output_file, file_format="npy"):
    ...
    Parameters:
        ...
        file_format (str): Format to save the embeddings ('npy' or 'txt').
    """
    if file_format == "npy":
        ...
        raise ValueError("Unsupported file format: Choose 'npy' or 'txt'")
...
def main():
    ...
    parser.add_argument(
        "--format", type=str, default="npy", choices=["txt"], help="File format to save embeddings."
    )
